...
namespace ERP.Shared.Repository
{
    public class SqlClient
    {
        public static string connStr
        {
            get
            {
                ...
                return "Data Source=LAPTOP-MARK-fly;Initial Catalog=MyDataBase;Persist Security Info=True;User ID=SA;Password=SUNSHINE@123,.;Encrypt=True;TrustServerCertificate=True";
            }
        }
